...
void loop() {
  ...
  switch (respuesta) {
    case 1: muestraIP();          break;
    case 2: pruebaClienteWeb();   break;
    case 3: pruebaServidorWeb();  break;
    case 4: pruebaBoton();        break;
    case 5: pruebaRele();         break;
    case 6: pruebaLedsRGB();      break;
    case 7: pruebaPantalla();     break;
    default: Serial.println(F("Opcion incorrecta.\nVuelve a introducir test a realizar")); break;
  }
}
